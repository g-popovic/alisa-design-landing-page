      ...
      <div className="contact-inner">
        <div className="contact-grid">
          ...
          <div>
            ...
            <a href="mailto:hello@formastudio.co" className="btn-contact">
        ...
        <div className="footer-bottom">
          <div className="footer-logo">Forma Studio</div>
          <div className="footer-copy">© 2026 Forma Studio Ltd. All rights reserved.</div>
