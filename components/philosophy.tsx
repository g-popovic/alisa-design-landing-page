			...
			<div className='philosophy-inner'>
				...
				<div className='philosophy-right'>
					<div className='philosophy-body'>
						{[
							"At Alisa Design, we believe that great interiors begin with deep listening. Before we sketch a single line, we immerse ourselves in your world — understanding how you move through space, what brings you calm, and what ignites your creativity.",
